    ...
    <div class="wrapper">
        ...
        <div class="section_container">
            ...
            <div id="side_nav">
                ...
                <div style="margin-top: 7px;"><img src="${pageContext.request.contextPath}/images/lm_banner_3.jpg" height="223" width="240"/></div>
            </div>
            <!-- 右侧焦点图区域 -->
            <div id="main_content ">
        ...
        <c:forEach items="${applicationScope.bigList}" var="list">
            <div class="products_list products_slider clear">
                <!-- 显示类别名称 -->
                <h2 class="sub_title">${list[0].categoryEntity.type}</h2>
                <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
                    <c:forEach items="${list }" var="product">
                        <li>
                            <a href="${shop}/product_get.action?productEntity.id=${product.id}" class="product_image">
                                <img src="${pageContext.request.contextPath}/images/${product.pic}" height="250" width="180" />
                            </a>
